...
public class GeminiController implements GeminiSwagger {
    ...
    @Override
    public ResponseEntity<WordGenerationResponse> generateWord(String category) {
    ...
    @Override
    public ResponseEntity<WordGenerationResponse> regenerateWord(String category, List<String> existingWords) {
